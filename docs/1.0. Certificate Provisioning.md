...
An EST Clients MUST have access to a good source of randomness in an acceptable amount of time. For more information, refer to [BRSKI](https://datatracker.ietf.org/doc/draft-ietf-anima-bootstrapping-keyinfra/) and [RFC 4086 - Randomness Requirements for Security][RFC-4086].
